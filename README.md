...
# Reproduction of results, public events moved (figure 3c)
...
that have moved back the public events NPI to 2020-03-12 and updated the Swedish `last_intervention` parameter to work with this.
