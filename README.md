...
# Reproduction of results, Sweden and UK (figure 4 and 5)
...
nature/data/regions.rds

that only contains Sweden and UK, and 

nature/utils/process-covariates.r

to remove the `last_intervention` parameter.
