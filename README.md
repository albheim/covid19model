...
# Reproduction of results, school + public (figure 3b)
...
nature/data/interventions.rds

nature/utils/process-covariates.r

that have reintroduced the school closure NPI as 2020-03-18 and moved back the public events NPI to 2020-03-12 and updated the Swedish `last_intervention` parameter to work with this.
